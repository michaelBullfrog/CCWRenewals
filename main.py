...
def update_manual_tracker_from_cisco(df):
    """
    Updates the Manual Tracker XLSX in OneDrive.

    It adds any missing Subscription IDs from Cisco and updates End Customer Name.
    It does NOT overwrite manual sales fields like Quoted, Signed, Sales Rep, Notes, etc.
    """
    ...
    # Update End Customer Name for matching Subscription IDs, but preserve all manual fields.
    ...
    # Keep required columns first. Preserve any extra columns after them.
